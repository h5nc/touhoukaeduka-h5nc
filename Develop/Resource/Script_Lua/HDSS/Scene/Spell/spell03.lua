function Spell_s03(playerindex, timer)
	...
	elseif timer == 1 then
		...
		hdssBGVALUE(playerindex, LConst_gamebg_spellid_1, SI_Spell_03_1, cenx, CenterY, 448, TotalH, col);
		hdss.Call(
			HDSS_BGVALEX,
			{
				playerindex, LConst_gamebg_spellid_2, SI_Spell_03_2, col
			},
			{
				cenx-TotalH*0.6, TotalCenterY-TotalH*0.6, 0, TotalH*1.5, TotalH*1.5
			},
			{
				0.4, 0, -9000, true, true
			}
		)
