function _Scene_s03_BuildOne(playerindex, cenx, x, y, z, siid, bgindex)
...
function Scene_s03(playerindex, timer)
	...
	elseif timer == 1 then
		...
		for i=0, 1 do
			hdss.Call(
				HDSS_BGVALEX,
				{
					playerindex, i+43, SI_Scene_03_4_01+i, col
				},
				{
			...
			hdss.Call(
				HDSS_BGVALEX,
				{
					playerindex, i+1, SI_Scene_03_4_03+i, sidecolor
				},
				{
	...
	elseif math.mod(timer, 16) == 0 then
		...
		_Scene_s03_BuildOne(playerindex, cenx, cenx-576, -1200, -1300, SI_Scene_03_3_01+math.mod(nowindex, 16), nowindex+3);
	end
	return true;
end